...
-------------------
  ...
  These reading materials is available at my [github.com/idebtor/HuStar/RobotAI](https://github.com/idebtor/HuStar/RobotAI).
...
After installation of GitHub Desktop, be a member if already not.
  ...
  ```
    ~/HuStar/RobotAI          # for AI for Robot
    ~/HuStar/AndApps          # Android apps development
  ```
...
![Check Path](https://github.com/idebtor/KMOOC-ML/blob/master/ipynb/images/anaconda_check_path.png "Check the PATH during Anaconda installation")
